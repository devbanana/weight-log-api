...
final class DispatchingEventStoreTest extends TestCase
{
    public function testItDelegatesToInnerEventStoreForAppend(): void
    {
        ...
        $event = new UserRegistered('user-123', 'test@example.com', new \DateTimeImmutable());
        $events = [$event];
        $expectedVersion = 0;
    ...
    public function testItDispatchesEachEventToMessageBusAfterSuccessfulAppend(): void
    {
        ...
        $event1 = new UserRegistered('user-123', 'test@example.com', new \DateTimeImmutable());
        $event2 = new UserRegistered('user-123', 'test@example.com', new \DateTimeImmutable());
    ...
    public function testItDelegatesToInnerEventStoreForGetEvents(): void
    {
        ...
        $aggregateType = 'App\Domain\User\User';
        $event1 = new UserRegistered('user-123', 'test@example.com', new \DateTimeImmutable());
        $event2 = new UserRegistered('user-123', 'updated@example.com', new \DateTimeImmutable());
